...
public abstract class CameraActivity extends AppCompatActivity
  ...
  public void onInit(int status) { // OnInitListener를 통해서 TTS 초기화
    if (status == TextToSpeech.SUCCESS) {
      int result = textToSpeech.setLanguage(Locale.KOREA); // TTS언어 한국어로 설정
  ...
  public void speakOut() {
    ...
    textToSpeech.speak("장보기 모드를 시작합니다", TextToSpeech.QUEUE_ADD, null, "id1");
  }
  ...
  public synchronized void onDestroy() {
    ...
    if (textToSpeech != null) { // 사용한 TTS객체 제거
      textToSpeech.stop();
